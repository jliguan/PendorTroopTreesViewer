        ...
        <Grid grow gutter="sm" justify="center" columns={24} >
            ...
            <Grid.Col span={16}>
                <Center>
                    <MediaQuery smallerThan={480} styles={{ display: 'none' }}>
                        <Title order={1} align="center">Order of the Raven Spear</Title>
                    </MediaQuery>
                    <MediaQuery largerThan={480} styles={{ display: 'none' }}>
                        <Title order={3} align="center">Order of the Raven Spear</Title>
                    </MediaQuery>
                </Center>
            ...
            <Grid.Col span={24} mt={10}>
                <Grid grow gutter="sm" justify="center" columns={24}>
                    ...
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('raven_spear', 'raven_spear_mercenary')}>
                                <AvatarTroop faction={'raven_spear'} name={'raven_spear_mercenary'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('raven_spear', 'knight_of_the_raven_spear')}>
                                <AvatarTroop faction={'raven_spear'} name={'knight_of_the_raven_spear'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                </Grid>
