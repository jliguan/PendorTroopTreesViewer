        ...
        <Grid grow gutter="sm" justify="center" columns={24} >
            ...
            <Grid.Col span={16}>
                <Center>
                    <MediaQuery smallerThan={480} styles={{ display: 'none' }}>
                        <Title order={1} align="center">Order of Eventide</Title>
                    </MediaQuery>
                    <MediaQuery largerThan={480} styles={{ display: 'none' }}>
                        <Title order={3} align="center">Order of Eventide</Title>
                    </MediaQuery>
                </Center>
            ...
            <Grid.Col span={24} mt={10}>
                <Grid grow gutter="sm" justify="center" columns={24}>
                    ...
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('eventide', 'eventide_ghilman')}>
                                <AvatarTroop faction={'eventide'} name={'eventide_ghilman'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('eventide', 'knight_of_eventide')}>
                                <AvatarTroop faction={'eventide'} name={'knight_of_eventide'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                </Grid>
