        ...
        <Grid grow gutter="sm" justify="center" columns={24} >
            ...
            <Grid.Col span={16}>
                <Center>
                    <MediaQuery smallerThan={480} styles={{ display: 'none' }}>
                        <Title order={1} align="center">Order of the Lion</Title>
                    </MediaQuery>
                    <MediaQuery largerThan={480} styles={{ display: 'none' }}>
                        <Title order={3} align="center">Order of the Lion</Title>
                    </MediaQuery>
                </Center>
            ...
            <Grid.Col span={24} mt={10}>
                <Grid grow gutter="sm" justify="center" columns={24}>
                    ...
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('lion', 'squire_of_the_lion')}>
                                <AvatarTroop faction={'lion'} name={'squire_of_the_lion'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('lion', 'knight_of_the_lion')}>
                                <AvatarTroop faction={'lion'} name={'knight_of_the_lion'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                </Grid>
