        ...
        <Grid grow gutter="sm" justify="center" columns={24} >
            ...
            <Grid.Col span={16}>
                <Center>
                    <MediaQuery smallerThan={480} styles={{ display: 'none' }}>
                        <Title order={1} align="center">Order of the Falcon</Title>
                    </MediaQuery>
                    <MediaQuery largerThan={480} styles={{ display: 'none' }}>
                        <Title order={3} align="center">Order of the Falcon</Title>
                    </MediaQuery>
                </Center>
            ...
            <Grid.Col span={24} mt={10}>
                <Grid grow gutter="sm" justify="center" columns={24}>
                    ...
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('falcon', 'talon_of_the_falcon')}>
                                <AvatarTroop faction={'falcon'} name={'talon_of_the_falcon'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('falcon', 'knight_of_the_falcon')}>
                                <AvatarTroop faction={'falcon'} name={'knight_of_the_falcon'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                </Grid>
