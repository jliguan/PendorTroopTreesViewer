        ...
        <Grid grow gutter="sm" justify="center" columns={24} >
            ...
            <Grid.Col span={16}>
                <Center>
                    <MediaQuery smallerThan={480} styles={{ display: 'none' }}>
                        <Title order={1} align="center">Order of the Kraken Cultists</Title>
                    </MediaQuery>
                    <MediaQuery largerThan={480} styles={{ display: 'none' }}>
                        <Title order={3} align="center">Order of the Kraken Cultists</Title>
                    </MediaQuery>
                </Center>
            ...
            <Grid.Col span={24} mt={10}>
                <Grid grow gutter="sm" justify="center" columns={24}>
                    ...
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('kraken_cultists', 'storm_sister')}>
                                <AvatarTroop faction={'kraken_cultists'} name={'storm_sister'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                    <Grid.Col span={12}>
                        <Center>
                            <UnstyledButton onClick={() => showStats('kraken_cultists', 'kraken_riddari')}>
                                <AvatarTroop faction={'kraken_cultists'} name={'kraken_riddari'}></AvatarTroop>
                            </UnstyledButton>
                        </Center>
                    </Grid.Col>
                </Grid>
